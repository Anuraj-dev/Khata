...
**Files:** `convex/trips.ts`, `convex/schema.ts`, `convex/smsParser.ts` (new), `convex/smsIngest.ts` (new), `convex/http.ts`, `apps/web/src/screens/TripDetailScreen.tsx`, `apps/web/src/components/DaySectionHeader.tsx`, `apps/web/src/screens/ExpensesScreen.tsx`, `apps/web/src/lib/smsBackground.ts` (new), `apps/web/src/lib/smsPoller.ts`, `apps/web/src/hooks/useSmsPoller.ts`, `apps/web/android/.../SmsReceiver.java` (new), `apps/web/android/.../SmsPlugin.java`, `apps/web/android/app/src/main/AndroidManifest.xml`, `.github/workflows/build-apk.yml`.
